...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
    ...
    private void Awake() {
        ...
        //TODO: Do we actually want this client-side?
        UpdateLayer();
        WindowConfig.allowEnemyTriggerThroughWindows.SettingChanged += (_, _) => UpdateLayer();
    }

    public virtual void UpdateLayer() => gameObject.layer = LayerMask.NameToLayer(WindowConfig.allowEnemyTriggerThroughWindows.Value? "Railing" : "Room");
